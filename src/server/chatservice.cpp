...
MsgHandler ChatService::getHandler(int msgid)
{
    ...
    {
        // LOG_ERROR << "mesgid:" << msgid << "can not find handler!";
        // string errstr = "msgid:" + to_string(msgid) + "can not find handler!";
        // 返回一个默认的处理器，空操作 lamda表达式
